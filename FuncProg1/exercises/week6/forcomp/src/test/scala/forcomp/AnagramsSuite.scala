...
class AnagramsSuite extends FunSuite {
  ...
  //    val occurrences: Occurrences = List(('a', 2), ('b', 2), ('c', 3))
  //    val expanded = for ((letter, count) <- occurrences; index <- 1 to count) yield (letter, index)
  //    println(expanded)
  //
  //    println(combinations(occurrences))
  //    println(combinations2(occurrences))
  //
  //  }
